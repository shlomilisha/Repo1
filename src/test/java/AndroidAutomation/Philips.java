...
public class Philips extends Device{
//	static Process process;
	
	

	public Philips(String name, String vender, String IP , String gamepad) {
		super();
		this.name = name;
		this.vender = vender;
		this.IP = IP;
	...
	public void MoveRight(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 3 16 1");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 3 16 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public void MoveLeft(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 3 16 4294967295");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 3 16 0");
	...
	public void MoveUp(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 3 17 4294967295");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 3 17 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public void MoveDown(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 3 17 1");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 3 17 0");
	...
	public void XButton(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 1 307 1");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 1 307 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public void AButton(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 1 304 1");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 1 304 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public void BButton(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 1 305 1");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 1 305 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
	...
	public void YButton(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 1 308 1");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 1 308 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public void LBButton(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 1 310 1");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 1 310 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public void LTButton(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 3 2 255");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 3 2 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public void RBButton(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 1 311 1");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 1 311 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public void RTButton(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 3 5 255");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 3 5 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent "+this.getGamepad()+" 0 0 0");
			try {
				Thread.sleep(1000);
...
public static void pullClientLogcat(Philips philips,int loopNumer,String currentTime ) throws IOException{
		runADBCommand("adb -s "+philips.getIP() +":5555 logcat -d >C:/Testes/"+currentTime+"/"+philips.getName()+"_"+loopNumer+"_Logcat.txt *:S Playcast");
