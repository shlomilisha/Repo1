...
public class FireTv2014 extends Device{
//	static Process process;
	
	

	public FireTv2014(String name, String vender, String IP , String gamepad, boolean connected) {
		super();
		this.name = name;
		this.vender = vender;
		this.IP = IP;
	...
	public void MoveRight(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 3 16 1");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 3 16 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public void MoveLeft(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 3 16 4294967295");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 3 16 0");
	...
	public void MoveUp(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 3 17 4294967295");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 3 17 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public void MoveDown(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 3 17 1");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 3 17 0");
	...
	public void XButton(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 1 307 1");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 1 307 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public void AButton(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 1 304 1");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 1 304 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public void BButton(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 1 305 1");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 1 305 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public void YButton(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 1 308 1");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 1 308 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public void LBButton(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 1 310 1");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 1 310 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public void LTButton(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 3 2 255");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 3 2 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public void RBButton(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 1 311 1");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 1 311 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public void RTButton(String IP, Integer times)
		...
		for (int s = 0; s < times; s++) {
			...
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 3 5 255");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 3 5 0");
			runADBCommand("adb -s " + IP
					+ ":5555 shell sendevent /dev/input/event5 0 0 0");
			try {
				Thread.sleep(1000);
	...
	public static void pullClientLogcat(FireTv2014 fireTv2014,int loopNumer,String currentTime ) throws IOException{
		runADBCommand("adb -s "+fireTv2014.getIP() +":5555 logcat *:S Playcast->C:/Testes/"+currentTime+"/"+fireTv2014.getName()+"_"+loopNumer+"_Logcat.txt");
		System.out.println("Saved logcat for device "+fireTv2014.getName());
