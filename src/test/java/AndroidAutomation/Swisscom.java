...
public class Swisscom extends Device{
//	static Process process;
	
	

	public Swisscom(String name, String vender, String IP , String gamepad) {
		super();
		this.name = name;
		this.vender = vender;
		this.IP = IP;
	...
	public static void pullClientLogcat(Philips philips,int loopNumer,String currentTime ) throws IOException{
		runADBCommand("adb -s "+philips.getIP() +":5555 logcat *:S Playcast->C:/Testes/"+currentTime+"/"+philips.getName()+"_"+loopNumer+"_Logcat.txt");
		System.out.println("Saved logcat for device "+philips.getName());
